...
STD_MODULES = $(addprefix std/, algorithm array base64 bigint bitmanip	\
        ...
        file format functional getopt gregorian intrinsic json loader	\
        math md5 metastrings mmfile numeric outbuffer path perf			\
        process random range red_black_tree regex regexp signals		\
