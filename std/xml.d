...
class Element : Item
{
     ...
     * --------------
     */
    void opOpAssign(string op : "~") (Text item)
    {
        texts ~= item;
        appendItem(item);
    }
     ...
     * --------------
     */
    void opOpAssign(string op : "~") (CData item)
    {
        cdatas ~= item;
        appendItem(item);
    }
     ...
     * --------------
     */
    void opOpAssign(string op : "~") (Comment item)
    {
        comments ~= item;
        appendItem(item);
    }
     ...
     * --------------
     */
    void opOpAssign(string op : "~") (ProcessingInstruction item)
    {
        pis ~= item;
        appendItem(item);
    }
     ...
     * --------------
     */
    void opOpAssign(string op : "~") (Element item)
    {
        elements ~= item;
        appendItem(item);
    }
