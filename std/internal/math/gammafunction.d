...
@safe unittest
{
    ...
    foreach (test; testData)
        assert(isClose(logmdigammaInverse(test[0]), test[1], 2e-15));

    assert(isClose(logmdigamma(logmdigammaInverse(1)), 1, 1e-15));
    assert(isClose(logmdigamma(logmdigammaInverse(real.min_normal)), real.min_normal, 1e-15));
    assert(isClose(logmdigamma(logmdigammaInverse(real.max/2)), real.max/2, 1e-15));
    assert(isClose(logmdigammaInverse(logmdigamma(1)), 1, 1e-15));
    assert(isClose(logmdigammaInverse(logmdigamma(real.min_normal)), real.min_normal, 1e-15));
    assert(isClose(logmdigammaInverse(logmdigamma(real.max/2)), real.max/2, 1e-15));
}
