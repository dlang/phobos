...
unittest
{
    ...
    static assert(isSubtypeOf!(BarFoo, Foo));
    static assert(isSubtypeOf!(BarFoo, Bar));
}
...
unittest
{
    ...
    {
        int foo(int i, string s) @safe { return 0; }
        double foo2(string s) @safe { return 1; }
    }
...
//Struct with static member variable/function
unittest
{
    struct Foo
    {
...
//Alt Struct with static member variable/function
unittest
{
    struct Foo
    {
