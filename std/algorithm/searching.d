 ...
 *
 * Returns:
 * An instance of `BoyerMooreFinder` that can be used with $(D find()) to
...
/++
    ...
    before $(D pred(haystack.front)) is `true`.
  +/
...
`pred`, call $(D find!(pred)(retro(haystack))). See $(REF retro, std,range).
