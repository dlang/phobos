...
/**
Implements functionality to read and write JSON5 values.

JSON5 is a lightweight data interchange format commonly used in web services and configuration files.
It's easy for humans to read and write, and it's easy for machines to parse and generate.

This module primarily deals with the JSON5 extension. For parsing the original
JSON format, please see the $(MREF_ALTTEXT std.json, std, json) module instead.
...
Authors:   Jeremie Pelletier, David Herberth, Robert Schadek
References: $(LINK http://json5.org/)
Source:    $(PHOBOSSRC std/json5.d)
*/
/*
