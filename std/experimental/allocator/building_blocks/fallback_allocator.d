...
struct FallbackAllocator(Primary, Fallback)
{
    ...
    */
    ...
    defines `expand`. It works as follows. If $(D primary.owns(b)), then the
    ...
    */
    ...
    `reallocate` works as follows. If $(D primary.owns(b)), then $(D
    ...
    */
    ...
    define    `deallocate`. It works as follows. If $(D primary.owns(b)),
