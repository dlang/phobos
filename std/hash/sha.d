 ...
 * )
 *
 * Source: $(PHOBOSSRC std/hash/_sha.d)
 *
 * Macros:
 *      WIKI = Phobos/StdSha1
...
struct SHA1
{
    ...
    public:
        ...
        /**
         * Returns the finished SHA1 digest. This also calls $(LREF start).
         *
         * Examples:
         * --------
         * //Simple example
        ...
        ///ditto
        @trusted nothrow pure void finish(ref ubyte[20] data)
        {
            uint index, padLen;
 ...
 * ---------
 */
public alias digest!SHA1 sha1Of;
