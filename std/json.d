 ...
 *
 * Note: A getter is a function that returns a type and has 0 parameters. 
 *       A setter is a function taht returns void and has 1 parameter
 */
struct jsonField
{
    /**
...
private
{
    JSONValue serializeAutoObj(T)(auto ref T obj)
    {
    ...
    JSONValue serializeJSONArray(T)(auto ref T obj)
    {
    ...
    T deserializeAutoObj(T)(auto ref JSONValue value)
    {
    ...
    T deserializeJSONArray(T)(auto ref JSONValue value)
    {
        T ret;
