 ...
 * D's eh mechanism on Windows is layered on top of Windows SEH.
 *
...
{
        enum  { MAKE_EXCEPTION_CODE = (((severity) << 30) | (1 << 29) | (0 << 28) | ((facility) << 16) | (exception)) };
}
