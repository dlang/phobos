...
OBJS= assert.obj deh.obj isbase.obj modulo.obj new.obj switch.obj complex.obj \
...
SRC= modulo.c new.cpp switch.d complex.c critical.c fpu.d \
	isbase.c aa.c vaa.c interface.c arraysetlength.cpp minit.asm
