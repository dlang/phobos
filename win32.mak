...
#can't place SRC_STD_HASH in SRC_STD_REST because of out-of-memory issues
SRC_STD_HASH= std\hash\crc.d std\hash\sha.d std\hash\md.d std\hash\hash.d
SRC_STD_4= std\uuid.d $(SRC_STD_HASH)
...
DOCS=	$(DOC)\object.html \
	...
	$(DOC)\std_conv.html \
	$(DOC)\std_cpuid.html \
	$(DOC)\std_hash_crc.html \
	$(DOC)\std_hash_sha.html \
	$(DOC)\std_hash_md.html \
	$(DOC)\std_hash_hash.html \
...
$(DOC)\std_hash_crc.html : $(STDDOC) std\hash\crc.d
	$(DMD) -c -o- $(DDOCFLAGS) -Df$(DOC)\std_hash_crc.html $(STDDOC) std\hash\crc.d

$(DOC)\std_hash_sha.html : $(STDDOC) std\hash\sha.d
	$(DMD) -c -o- $(DDOCFLAGS) -Df$(DOC)\std_hash_sha.html $(STDDOC) std\hash\sha.d

$(DOC)\std_hash_md.html : $(STDDOC) std\hash\md.d
	$(DMD) -c -o- $(DDOCFLAGS) -Df$(DOC)\std_hash_md.html $(STDDOC) std\hash\md.d

$(DOC)\std_hash_crc.html : $(STDDOC) std\hash\hash.d
	$(DMD) -c -o- $(DDOCFLAGS) -Df$(DOC)\std_hash_hash.html $(STDDOC) std\hash\hash.d
