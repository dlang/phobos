...
{   void *p;
    ...
    //WPRINTF(L"GC::malloc(size = %d, gcx = %p)\n", size, gcx);
    assert(gcx);
...
#if 0 // BUG: doesn't work because freebits() must also be cleared
...
#define printf 1 || printf
    ...
    //WPRINTF(L"\tdone, freedpages = %d, recoveredpages = %d\n", freedpages, recoveredpages);
